							...
							<div class="profile-left">
								...
								<div class="profile-header">
									...
									<div class="profile-main">
										<img src="{{$siswa->getGambar()}}" style="width:50%;" class="img-circle" alt="Avatar">
                                    ...
                                    <div class="panel-body">
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="#" class="nilai" data-type="text" data-pk="{{$mapel->id}}" data-url="/api/siswa/{{$siswa->id}}/editNilai" data-title = "Input Nilai"> {{$mapel->pivot->nilai}} </a></td>
                                                <td><a href="/guru/{{$mapel->guru_id}}/profile"> {{$mapel->guru->nama}} </a></td>
                                                <td>
                                                    <a href="/siswa/{{$siswa->id}}/{{$mapel->id}}/hapusNilai" class="btn btn-danger btn-sm" onclick="return confirm('Yakin akan dihapus?')" >Hapus</a>
                                                </td>
                                            </tr>
                                            @endforeach
                                            </tbody>
        ...
        <div class="modal-body">
            <form action="/siswa/{{$siswa->id}}/tambahNilai" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group {{$errors->has('nilai') ? 'has-error' : ''}}">
                    ...
                    <input type="text" class="form-control" id="nilai" name="nilai" placeholder="Masukan nilai" value="{{old('nilai')}}">
