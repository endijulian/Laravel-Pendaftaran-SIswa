...
<!-- start banner Area -->
<section class="banner-area relative" id="home" style="background: url('{{config('tampilan_website.image_banner_url')}}')" style="height: 200px;">
    <div class="overlay overlay-bg"></div>
    <div class="container">
        <div class="row fullscreen d-flex align-items-center justify-content-between">
            <div class="banner-content col-lg-9 col-md-12">
                <h1 class="text-uppercase">{{config('tampilan_website.welcome_message')}}</h1>
                <p class="pt-10 pb-10">
                        {{config('tampilan_website.sub_welcome')}}
                </p>
                <a href="{{config('tampilan_website.message_button_url')}}" class="primary-btn text-uppercase">{{config('tampilan_website.message_button')}}</a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="single-feature">
                    <div class="title">
                        <h4>{{config('tampilan_website.home_feature_column_1_title')}}</h4>
                    </div>
                    <div class="desc-wrap">
                        <p>
                            {{config('tampilan_website.home_feature_column_1_content')}}
                        </p>
                        <a href="{{config('tampilan_website.home_feature_column_1_url')}}">{{config('tampilan_website.home_feature_column_1_text')}}</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="single-feature">
                    <div class="title">
                        <h4>{{config('tampilan_website.home_feature_column_2_title')}}</h4>
                    </div>
                    <div class="desc-wrap">
                        <p>
                            {{config('tampilan_website.home_feature_column_2_content')}}
                        </p>
                        <a href="{{config('tampilan_website.home_feature_column_2_url')}}">{{config('tampilan_website.home_feature_column_2_text')}}</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="single-feature">
                    <div class="title">
                        <h4>{{config('tampilan_website.home_feature_column_3_title')}}</h4>
                    </div>
                    <div class="desc-wrap">
                        <p>
                            {{config('tampilan_website.home_feature_column_3_content')}}
                        </p>
                        <a href="{{config('tampilan_website.home_feature_column_3_url')}}">{{config('tampilan_website.home_feature_column_3_text')}}</a>
                    </div>
                </div>
            </div>
        </div>
